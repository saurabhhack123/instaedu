...
int readSATscores(int a[], int b[], int c[], int d[],int e[],int n);
void printArray(int arr[], int k);
int sumscores(int b[], int c[], int d[], int k, int t[]);
int findmax(int grades[], int SIZE, int id[]);
int tallyarea(int grades[], int SIZE, int z);
ifstream infile;
ofstream outfile;
...
int main()
{
    ...
    int idNum[SIZE], readingscores[SIZE], mathscores[SIZE], writingscores[SIZE], totalscores[SIZE];
